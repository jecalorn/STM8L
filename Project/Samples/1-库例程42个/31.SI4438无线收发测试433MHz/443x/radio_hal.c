...
#define SEL_L()       GPIO_ResetBits(GPIOD,GPIO_Pin_5)                  // SPI片选信号，低电平有效
#define SEL_H()       GPIO_SetBits(GPIOD,GPIO_Pin_5)  

#define SDN_L()       GPIO_ResetBits(GPIOD,GPIO_Pin_7)                 //芯片内部LDO使能信号，低电平正常供电，高电平停止供电，功耗最小 
#define SDN_H()       GPIO_SetBits(GPIOD,GPIO_Pin_7) 

#define IRQ_READ()    GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_6)         //中断输出引脚，有中断时输出低
